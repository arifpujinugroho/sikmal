...
@section('footer')
    ...
    <script>
        $(function() {
            ...
            $.ajax({
                url: '{{ URL::to('admin/datagrafikpkm') }}/{{$tahunpkm}}/{{$tipepkm}}',
                dataType: 'JSON',
                type: 'GET',
    ...
    <script>
        $(function() {
            ...
            $.ajax({
                url: '{{ URL::to('admin/datagrafikpkmlengkap') }}/{{$tahunpkm}}/{{$tipepkm}}',
                dataType: 'JSON',
                type: 'GET',
                data: {get_values: true},
                success: function(response) {
