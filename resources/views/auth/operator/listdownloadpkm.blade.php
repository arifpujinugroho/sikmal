        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h4>List Download PKM {{$fakultas}}</h4>
                            ...
                            <div class="dt-responsive table-responsive">
                                <table id="downloadTable" class="table table-striped">
                                    ...
                                    <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(is_null($t->file_proposal))
                                                            ...
                                                            @endif
                                                        @else
                                                            <a href="{{url('opt/downpro')}}/{{Crypt::encryptString($t->id_file_pkm)}}"><button class="btn btn-mini btn-success"><i class="fa fa-download"></i> Unduh Proposal</button></a><br>
                                                            <p>{{$t->time_proposal}}</p>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if(is_null($t->file_laporan_kemajuan))
                                                            ...
                                                            @endif
                                                        @else
                                                            <a href="{{url('opt/downlapkem')}}/{{Crypt::encryptString($t->id_file_pkm)}}"><button class="btn btn-mini btn-success"><i class="fa fa-download"></i> Unduh Lap.Kemajuan</button></a><br>
                                                            <p>{{$t->time_proposal}}</p>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if(is_null($t->file_laporan_akhir))
                                                            ...
                                                            @endif
                                                        @else
                                                            <a href="{{url('opt/downlapakh')}}/{{Crypt::encryptString($t->id_file_pkm)}}"><button class="btn btn-mini btn-success"><i class="fa fa-download"></i> Unduh Lap.Akhir</button></a><br>
                                                            <p>{{$t->time_proposal}}</p>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if(is_null($t->file_ppt))
                                                            ...
                                                            @endif
                                                        @else
                                                            <a href="{{url('opt/downppt')}}/{{Crypt::encryptString($t->id_file_pkm)}}"><button class="btn btn-mini btn-success"><i class="fa fa-download"></i> Unduh File PPT</button></a>
                                                        @endif
                                                    </td>
                                                    <td>   
                                                        @if(is_null($t->poster))
                                                            ...
                                                            @endif
                                                        @else
                                                            <a href="{{url('opt/downposter')}}/{{Crypt::encryptString($t->id_file_pkm)}}"><button class="btn btn-mini btn-success"><i class="fa fa-download"></i> Unduh Poster</button></a><br>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if(is_null($t->file_artikel))
                                                            ...
                                                            @endif
                                                        @else
                                                            <a href="{{url('opt/downartikel')}}/{{Crypt::encryptString($t->id_file_pkm)}}"><button class="btn btn-mini btn-success"><i class="fa fa-download"></i> Unduh Poster</button></a><br>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr>
                                                <td colspan="8" class="text-center f-s-italic">Belum ada Usulan PKM</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
...
<div class="modal fade" id="upload-proposal" tabindex="-1" role="dialog" aria-labelledby="uploadProposalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{url('opt/uploadproposal')}}" class="form-validation" method="post" enctype="multipart/form-data">
			@csrf
...
<div class="modal fade" id="upload-kemajuan" tabindex="-1" role="dialog" aria-labelledby="uploadKemajuanLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{url('opt/uploadkemajuan')}}" class="form-validation" method="post" enctype="multipart/form-data">
			@csrf
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
...
<div class="modal fade" id="upload-akhir" tabindex="-1" role="dialog" aria-labelledby="uploadAkhirLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="{{url('opt/uploadakhir')}}" class="form-validation" method="post" enctype="multipart/form-data">
			@csrf
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
